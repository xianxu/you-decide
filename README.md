...
│   ├── SKILL.md, sub-skills, templates/, calibration-skills/
├── candidates/                          ← AI-curated factual substrate
├── elections/
├── controversies/
├── sources/                             ← per-jurisdiction source registries
├── reviews/                             ← review-state tracking
