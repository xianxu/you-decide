...
# John Pimentel — 2026 CA Board of Equalization D2

## Background

Democrat. Menlo Park resident. First-generation college graduate (San Joaquin Delta Community College → UC Berkeley → Harvard MBA). Career spans private-sector clean energy/infrastructure and government service.

**Government:** San Mateo County Community College District Trustee (led free-tuition initiative for 33,500+ county residents); California Deputy Secretary for Transportation (highway rebuild contracts, CHP headcount expansion, merged State Police into CHP); Menlo Park Housing Commissioner (promoted parking-lot-to-housing conversion downtown). Past role as Governor's Higher Education Advisor.
...
- **Community College District Trustee:** Led free-tuition program for county residents — concrete deliverable with measurable enrollment impact (33,500+ students). Positive institutionalist signal: worked through board governance, not activism.
- **Deputy Secretary for Transportation:** Highway rebuild contracting; CHP merger/expansion. Administrative competence signal; no reported controversies from that tenure.
...
| Tier | Source | URL |
|---|---|---|
| A | John Pimentel campaign site | https://johnpimentel.com/ |
| B | CalMatters voter guide 2026 | https://calmatters.org/california-voter-guide-2026/board-of-equalization/ |
| B | CalMatters — "Why are so many people running for Board of Equalization in 2026?" | https://calmatters.org/politics/2026/05/board-of-equalization-election/ |
| B | The Almanac — "Should the state's tax commission even exist?" (2026-05-14) | https://www.almanacnews.com/election/2026/05/14/should-the-states-tax-commission-even-exist/ |
| B | GrowSF voter guide (questionnaire — no response) | https://growsf.org/voter-guide/questionnaires/june-2026/john-pimentel/ |
| C (avoid for decisive claims) | BallotReady profile | https://www.ballotready.org/people/john-pimentel |
