...
**Race dynamics:** This is a safe-D district (Berman has held it since 2016). In a top-two primary, the likely November matchup is Berman vs. whichever Republican places second — possibly Giorgetti vs. Johnson competing for that slot. If Berman wins outright in June (>50%), the general is still top-2 finishers.
...
**AI regulation:**
On a state role in AI regulation, said "No role" — emphasizing instead that those who were misusing AI "should be prosecuted through the criminal justice system" (a criminal-enforcement posture rather than preemptive state regulation). ([SM Daily Journal](https://www.smdailyjournal.com/news/local/marc-berman-defends-district-23-assembly-seat-against-republican-challengers/article_167f1bcb-a7fb-40af-9251-43468214cc09.html))
...
No elective or appointive public office found. No legislation, committee work, or regulatory record. Business background unverified from public sources.
...
1. **Thin public record:** No campaign website, no detailed policy platform, no documented professional background. "I'll fix it. That's what I do" is the only documented response to a specific policy question — suggests either a candidate who hasn't done the homework or one who hasn't engaged with press. Either reading is concerning.
2. **Challenger in a safe-D district:** AD-23 is not competitive at the top line. The race matters for (a) expressive signal in June and (b) whether a more vs. less coherent Republican reaches November to provide contrast with Berman.
3. **Limited differentiation from David Johnson:** Both are regulation-cut, cost-of-living-focused Republicans. Without a detailed platform or contrast, it is hard to prefer Giorgetti over Johnson on substance.

## Calibration notes (trump-era-cater-discount)

No institutionalist red flags documented — no 2020-fraud claims, no ballot-interference, no strongman rhetoric. Trump-supporter label applies; advocacy for policy-focus-over-personality is actually a mild anti-personalist signal. Discount not triggered because there is nothing to discount. The absence of red flags is notable for a 2025-era CA Republican.
...
| [Ballotpedia — CA Assembly elections 2026](https://ballotpedia.org/California_State_Assembly_elections,_2026) | C | Secondary / encyclopedic | Neutral |
