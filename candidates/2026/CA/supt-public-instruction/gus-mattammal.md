...
Source: votegus.org/policy (Tier A) and EdSource profile (Tier B).

- **Literacy / science of reading:** Supports the "science of reading" as the correct framework for literacy instruction; views the current state approach as underperforming.
...
No public-office record (two prior races lost). Tutoring business track record: 22 years at Advantage Testing; expanded pro bono programs nationwide. Book published but no independent reviews surfaced. Did not meet EdSource's April forum criteria (required prior election to public office involving education policy); was given a separate video interview instead. No governing record to evaluate.
