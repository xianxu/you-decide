...
# Rule 2): refresh when the live `candidates/2026/CA/**` glob differs from this list.
input-profiles: 39
sources:
  - candidates/2026/CA/governor/*.md (8)
  - candidates/2026/CA/San-Mateo/assessor-clerk-recorder/*.md (3)
  - candidates/2026/CA/San-Mateo/county-controller/*.md (2)
  - candidates/2026/CA/San-Mateo/county-superintendent-schools/*.md (2)
  - candidates/2026/CA/San-Mateo/supervisor-d3/*.md (2)
  - candidates/2026/CA/assembly-d21/*.md (2)
  - candidates/2026/CA/assembly-d23/*.md (3)
  - candidates/2026/CA/boe-d2/*.md (3)
  - candidates/2026/CA/supt-public-instruction/*.md (3)
  - candidates/2026/CA/us-house-d15/*.md (5)
  - candidates/2026/CA/us-house-d16/*.md (4)
  - candidates/2026/CA/Santa-Clara/district-attorney/*.md (2)
...
- Candidate profiles in `candidates/2026/CA/` (39 files; set enumerated in frontmatter `sources:`, refreshed 2026-05-29; derived from Tier A/B sources per the source-hygiene calibration skill)
