...
- **C1 (Critical) — privacy leak survivor.** `candidates/.../district-attorney/daniel-chung.md`
...
- **I1 (Important).** `you-decide/identify-controversies.md:28` had operative path
  ...
  `controversies/<year>/<state>.md` (shared substrate).
...
- No embedded read/scoring/verdict sections remain in `candidates/`.
- No "Xian" token in `candidates/`, `elections/`, `controversies/`, `sources/`,
