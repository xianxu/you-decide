...
- `data/candidates/2026/CA/**/*.md`
- `data/elections/2026/*.md`
- `data/controversies/2026/*.md`
...
#### `data/elections/2026/2026-06-02-CA-primary.md` - ballot-scope overclaim
...
#### `data/elections/2026/2026-06-02-CA-primary.md` - statewide candidate undercount
...
#### `data/elections/2026/2026-06-02-CA-primary.md` - district candidate omissions
...
#### `data/elections/2026/2026-06-02-CA-primary.md` - unresolved TBD in shared manifest
...
#### `data/controversies/2026/CA.md` - stale derivation count and path

Line 21 says the map is derived from 30 candidate profiles, but the current reviewed scope contains 39 candidate profiles under `data/candidates/2026/CA`. Line 145 points to stale private-brain path `data/life/politics/candidates/2026/CA/`.

Suggested fix: update the derivation count and use repo-root-relative `data/candidates/2026/CA/`.
...
#### `data/candidates/2026/CA/us-house-d16/sam-liccardo.md` - unverified campaign-finance claim
...
#### `data/candidates/2026/CA/us-house-d15/kevin-mullin.md` - 403/search-summary source leakage
...
#### `data/candidates/2026/CA/San-Mateo/assessor-clerk-recorder/jim-irizarry.md` - donor profile unverified
...
#### `data/candidates/2026/CA/San-Mateo/county-controller/juan-raigoza.md` - campaign-finance source blocked
...
#### `data/candidates/2026/CA/supt-public-instruction/william-mcgee.md` - search-result-only sources
...
- `data/candidates/2026/CA/San-Mateo/assessor-clerk-recorder/clinton-freeman.md`
- `data/candidates/2026/CA/San-Mateo/assessor-clerk-recorder/david-canepa.md`
- `data/candidates/2026/CA/San-Mateo/assessor-clerk-recorder/jim-irizarry.md`
- `data/candidates/2026/CA/San-Mateo/county-controller/juan-raigoza.md`
- `data/candidates/2026/CA/San-Mateo/county-controller/thomas-morgan.md`
...
- `data/candidates/2026/CA/assembly-d23/david-johnson.md`
- `data/candidates/2026/CA/assembly-d23/marc-berman.md`
...
- `data/candidates/2026/CA/governor/steve-hilton.md`
- `data/candidates/2026/CA/governor/tom-steyer.md`
- `data/candidates/2026/CA/governor/tony-thurmond.md`
- `data/candidates/2026/CA/governor/xavier-becerra.md`
...
- `data/candidates/2026/CA/supt-public-instruction/william-mcgee.md`
...
- `data/candidates/2026/CA/us-house-d16/jotham-stein.md`
- `data/candidates/2026/CA/us-house-d16/kevin-johnson.md`
- `data/candidates/2026/CA/us-house-d16/peter-soule.md`
