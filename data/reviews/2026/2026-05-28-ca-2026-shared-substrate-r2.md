...
base-review: data/reviews/2026/2026-05-28-ca-2026-shared-substrate.md
...
- `data/elections/2026/2026-06-02-CA-primary.md` no longer overclaims certified-complete statewide coverage.
...
- `data/controversies/2026/CA.md` now uses repo-relative `data/candidates/2026/CA/` and notes 39 profiles.
- `[[trump-era-cater-discount]]` now resolves via `you-decide/calibration-skills/trump-era-cater-discount.md`.

### important

#### `data/candidates/2026/CA/us-house-d15/kevin-mullin.md` - party-line characterization still asserted
...
#### `data/candidates/2026/CA/us-house-d15/kevin-mullin.md` - blocked/search-summary sources still listed as used evidence
