...
Janelle Kellman is a Democrat, an environmental attorney, and a former Mayor of Sausalito. She holds a J.D. from Stanford Law School (1998) and a B.A. from Yale (1995). [(Ballotpedia)](https://ballotpedia.org/Janelle_Kellman) [(janellekellman.com — Meet Janelle)](https://janellekellman.com/meet-janelle)
...
Sources below draw on her campaign site (primary) and nonpartisan voter guides.

**Housing:**
- Weak signal. Her priorities list "Reduce Home Insurance Costs," but framed via climate-risk and insurance-market stabilization rather than housing supply. [(janellekellman.com — Priorities)](https://janellekellman.com/priorities)
- No CEQA, zoning, or permitting-reform language surfaced. As a Sausalito planning commissioner and councilmember she "participated in housing development and land use," but no stated YIMBY / upzoning record was found. (inference — demand-side / insurance lean rather than supply-side)

**Energy:**
- Cost-aware and mechanism-heavy. Headline goal is to "Cut Electricity Costs by 25%" (on some pages "by half over a decade"). [(janellekellman.com — Priorities)](https://janellekellman.com/priorities)
- Mechanisms cited: (a) dynamic / time-of-use pricing via "smart devices, storage, programs that reward people"; (b) a mandate that large industrial users including AI data centers cut peak consumption; (c) financing grid hardening through "low-cost public bonds and competitive bidding"; (d) re-funding wildfire prevention to lower a fire-cost driver of bills. [(janellekellman.com — Priorities)](https://janellekellman.com/priorities)
- This is a cost-down framing, but it relies on public bonds and is climate-premised. (inference on the caveat)

**Public safety:**
- As Sausalito Mayor she "declared a state of emergency for a local homeless encampment and led a humanitarian response to move people into housing," with her campaign stating local homelessness "dropped by more than half." [(janellekellman.com — Meet Janelle)](https://janellekellman.com/meet-janelle)
- A strict-rules-plus-care posture; no defund rhetoric surfaced. (inference)

**Fiscal:**
- Spend / bond-leaning. Proposes free community college, funded by "redirecting K–14 resources including one-time Prop 98 funds" — reallocation rather than a new tax — and grid hardening via public bonds. [(janellekellman.com — Priorities)](https://janellekellman.com/priorities)
- No wealth-tax advocacy and no anti-tax pledge surfaced; a program-expansion Democrat. (inference)
...
- Endorsed by LPAC, the Stonewall Democratic Club, and East Area Progressive Democrats. [(Bay Area Reporter)](https://www.ebar.com/story/153699)

**DEI / identity:** Uses identity / representation framing (LGBTQ representation, equity language) but pairs it with outcomes (homelessness down ~50%, bills down 25%). Mixed.

**Foreign policy (Israel / Gaza):**
- No Israel-policy stance surfaced. On antisemitism she calls Jewish safety "a civil rights issue" and says "Jewish students need to know they can fully participate in campus life." She is Jewish and competed in the Maccabiah Games. [(J. — Jewish news of Northern California)](https://jweekly.com/2026/05/26/two-jewish-bay-area-ex-mayors-are-running-for-california-lieutenant-governor/)

## Record / past performance

**Sausalito local government (~10 years):**
- Planning commissioner (about four years), city councilmember (elected 2020), Mayor (2022). [(Ballotpedia)](https://ballotpedia.org/Janelle_Kellman) [(janellekellman.com — Meet Janelle)](https://janellekellman.com/meet-janelle)
- As Mayor, declared a local state of emergency over a homeless encampment and led a response her campaign says cut local homelessness by more than half. [(janellekellman.com — Meet Janelle)](https://janellekellman.com/meet-janelle)

**Climate / sea-rise work:**
- Founded the Center for Sea Rise Solutions, a climate-risk nonprofit. Her sea-rise work is positioned as adaptation / infrastructure — "port infrastructure, agriculture, business expansion" — and her campaign says she "secured millions for coastal resilience." This reads as resilience-infrastructure work rather than housing or energy buildout, and any future State Lands Commission / Regents role here is ambiguous. (inference) [(janellekellman.com — Meet Janelle)](https://janellekellman.com/meet-janelle) [(CalMatters voter guide)](https://calmatters.org/california-voter-guide-2026/lieutenant-governor/)

**Earlier career:** Environmental attorney (Stanford J.D., 1998). [(Ballotpedia)](https://ballotpedia.org/Janelle_Kellman)

**Institutionalism / integrity:** No scandals or election-administration violations surfaced; campaign theme is to "restore trust in government." No hypocrisy flags surfaced; the throughline (climate attorney → climate-focused campaign) is coherent. (inference)

## Endorsements & donors

**Endorsements:**
- California Legislative Jewish Caucus; California Jewish Democrats; Bay Area Jewish Coalition–Action. [(J. — Jewish news of Northern California)](https://jweekly.com/2026/05/26/two-jewish-bay-area-ex-mayors-are-running-for-california-lieutenant-governor/)
...
| 7 | [Bay Area Reporter — Kellman LG coverage](https://www.ebar.com/story/153699) | B | LGBTQ-press coverage; social-liberty framing, LGBTQ endorsements, low viability |
